        ...
        <div class="row g-2">
            <div class="col-6">
                ...
                <div class="card p-2">
                    ...
                    <input type="url" id="imageUrl" name="imageUrl" class="form-control" value="{{$project['imageUrl']}}">
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card p-2">
                    ...
                    <input type="url" id="link" name="link" class="form-control" value="{{$project['link']}}">
                </div>
